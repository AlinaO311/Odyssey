...
# ------------------------
	...
	printf "\nCreating Imputation Project Folder within Phase Directory\n\n"
		...
		mkdir Reference; mkdir ${BaseName}_Phasing; mkdir  ${BaseName}_Phasing/Scripts2Shapeit
...
--thread ${PhaseThreads} \
--chrX \
--input-bed ${BaseName}_Phasing/Ody2_${BaseName}_PhaseReady.chr23 \
...
${Eagle2_Exec} --bfile ${BaseName}_Phasing/Ody2_${BaseName}_PhaseReady.chr${chr} \
...
${Eagle2_Exec} --bfile ${BaseName}_Phasing/Ody2_${BaseName}_PhaseReady.chr23 \
--geneticMapFile=./Reference/${GeneticMap} \
