...
if (VCF2PGEN=="T" || VCF2PGEN=="t")
	{
		...
		system(paste0(plink, " --vcf ", VCF_Input, " --id-delim _ --update-sex ", Sex_Input, " col-num=5 --memory ",ActualGWAS_Memory, "000 --make-pgen --out ./GWAS/Datasets/", GWASDatasetName))

		#plink --vcf ${VCF_Input} --id-delim _ --update-sex ${Sex_Input} col-num=5 --memory ActualGWAS_Memory000 require --make-pgen --out ./GWAS/Datasets/${GWASDatasetName}
...
if (PGEN_Check == "TRUE" && Pheno_Check == "TRUE" && Sex_Check == "TRUE")
	...
	# Set Pheno path as variable
		PHENO_FILE_PATH <- paste0("./GWAS/Phenotype/", Pheno_File)
